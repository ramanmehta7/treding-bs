...
cursor = db.cursor()
cursor.execute("CREATE DATABASE trending DEFAULT CHARSET = utf8mb4 DEFAULT COLLATE = utf8mb4_unicode_ci")
db = mysql.connector.connect(
  host="localhost",
  user="root",
  password="",
...
cursor.execute("CREATE TABLE IF NOT EXISTS videos (title VARCHAR(1024), description TEXT, url VARCHAR(256), views VARCHAR(16)) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE utf8mb4_unicode_ci")
